...
<?php
    function view_income_history(){
        ...
        $_SESSION['msg'] = "<center><strong>Income Report</strong></center>";
        $_SESSION['msg'] .= "<center><strong>From: $_POST[from_date]</strong></center>";
        $_SESSION['msg'] .= "<center><strong>To: $_POST[to_date]</strong></center>";

        $sql = "SELECT income, income_date, income_ref FROM accounts WHERE income_date BETWEEN '$from' AND '$to' ORDER BY income_date";
