...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="container col-md-10">
            <div class="card">
                <div class="card-header">Batchwise Payment List</div>
                <div class="card-body">
                    <?php view_list(); ?>
                </div>
            </div>
...
<?php
    function view_list(){
        ...
        $sql = "SELECT students.first_name, students.last_name, students.program_roll, students.program, students.subjects, students.batch_day, students.batch_time, payment.payment_for_month, payment.payment_date, payment.paid_amount 
            ...
            WHERE (payment.payment_date BETWEEN '$from' AND '$to') AND students.program='$program' AND students.class='$class' AND students.batch_day='$bDay' AND students.batch_time='$bTime' ORDER BY payment.payment_date";
