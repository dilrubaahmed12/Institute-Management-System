...
<div class="container-fluid">
    <div class="row">
		...
		<?php
			if(is_file($_GET['text']) && is_file($_GET['nolist'])){
			    ...
			    if(stristr($_SERVER['HTTP_USER_AGENT'], 'x64')){
			        $cmd = "cd C:/Program Files (x86)/SMSCaster/ && smscaster.exe -Compose ".$file_name." ".$sms_text." -Long";
			    }else{
			        $cmd = "cd C:/Program Files/SMSCaster/ && smscaster.exe -Compose ".$file_name." ".$sms_text." -Long";
			    }
			    exec($cmd);
